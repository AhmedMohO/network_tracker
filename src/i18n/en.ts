...
export const en = {
  ...
  range: {
    ...
    thisCycle: 'This subscription',
    lastCycle: 'Previous subscription',
    custom: 'Custom',
    customChip: 'Custom…',
  ...
  limits: {
    title: 'Data limits',
    hint: 'Set a monthly limit to track it against your monthly subscription.',
    wifiHint: 'Set a monthly Wi-Fi limit to track it against your monthly subscription.',
    ...
    warnAt: 'Warn me at (%)',
    cycleDay: 'Monthly subscription renewal day',
    save: 'Save',
    saved: 'Limit saved.',
    ...
    over: 'Over by {{bytes}}',
    used: '{{percent}}% used',
    elapsed: '{{percent}}% through the monthly subscription',
    projected: 'At this rate you will use {{bytes}} this subscription.',
    projectedOver: 'At this rate you will use {{bytes}} — over your subscription limit.',
    a11y: '{{used}} of {{limit}} used, {{percent}} percent, {{elapsed}} percent through the monthly subscription.',
  },
  alerts: {
    ...
    mobile: {
      ...
      warnBody: '{{remaining}} left, with {{cycleRemaining}}% of the subscription to go.',
