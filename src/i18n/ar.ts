...
export const ar: typeof en = {
  ...
  family: {
    ...
    whatIsShared:
      'ما يُشارَك، مرة يوميًا وعدة مرات أخرى لبيانات اليوم حتى الآن: معرّف هذا الجهاز وتسميته، إجمالي استهلاك البيانات لكل تطبيق، أسماء التطبيقات، نافذة التغطية التي أبلغ عنها أندرويد عندما تختلف عمّا طُلب، ومع كل تحديث من تحديثات اليوم الأكثر تكرارًا: التطبيق الذي كان في المقدمة، نسبة شحن بطارية هذا الجهاز، وما إذا كان متصلًا ببيانات الجوال أو الواي فاي أو غير متصل.',
    whatNeverLeaves:
