...
export const ar: typeof en = {
  ...
  family: {
    ...
    whatIsShared:
      'ما يُشارَك، مرة يوميًا وعدة مرات أخرى لبيانات اليوم حتى الآن: معرّف هذا الجهاز وتسميته، إجمالي استهلاك البيانات لكل تطبيق، أسماء التطبيقات، ونافذة التغطية التي أبلغ عنها أندرويد عندما تختلف عمّا طُلب.',
    whatNeverLeaves:
